...
int main(int argc, char **argv) {
    ...
    printf(HCYN"NOTE: If you want to use Saturn as a HTTP server, you should use the official plugin httpsaturn. It's distributed by default.\n"reset);
    saturnConfiguration config = getConfig();
    printf("Starting on address "GRNHB"%s"reset".\n", config.ipAddress);
